      ...
      queries: [
        {
          ...
          retrieved: {
            ...
            metrics: { hitAtK: 1, recallAtK, precisionAtK: recallAtK / 10, mrrAtK: 1 },
            durationsMs: { embeddingMs: 1, retrievalMs: 1, totalMs: 2 },
          },
        },
      ],
      aggregates: {
        retrieved: {
          mean: { hitAtK: 1, recallAtK, precisionAtK: recallAtK / 10, mrrAtK: 1 },
          median: { hitAtK: 1, recallAtK, precisionAtK: recallAtK / 10, mrrAtK: 1 },
        },
      },
      timings: {
