...
<Accordions>
<Accordion title="Acknowledge the gap honestly">

"I don't have information about that in my knowledge base." This is better than a hallucinated answer because it's true and doesn't damage trust.

**With Unrag**: Check the `chunks` array length or the best score before generating an answer.

</Accordion>

<Accordion title="Suggest related topics">

"I didn't find an exact match, but here are some related topics..." Show the top results even if they're below threshold, but present them as suggestions rather than answers.

</Accordion>

<Accordion title="Offer to escalate">

Appropriate for support contexts: "I can't answer that directly, but I can connect you with a support agent who can help."

</Accordion>

<Accordion title="Fall back to general knowledge (with caveats)">

Works for some applications: "I don't have specific information in my documentation, but based on general knowledge..." This should be explicit so users know the answer isn't grounded in your content.
