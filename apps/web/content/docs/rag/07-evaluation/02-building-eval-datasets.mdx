...
**With Unrag**: The [eval battery](/docs/eval) provides a structured [dataset format](/docs/eval/datasets) for defining queries and ground truth, with built-in support for document and passage-level labels.
