...
**Technical documentation** typically works well at 200-400 words. This is large enough to include a complete section with its examples, small enough to be topically focused.

**Conversational content** like support tickets, chat logs, or FAQs often benefits from smaller chunks of 100-200 words. Each exchange or Q&A pair is a natural unit.

**Long-form prose** like articles, reports, or legal documents often needs larger chunks of 300-600 words to preserve narrative flow and complete arguments.

**Code** is a special case—size matters less than structure. A function might be 10 lines or 100 lines; what matters is keeping it intact. We'll cover code chunking specifically in the structure-aware chunking chapter.

These are starting points, not prescriptions. Test on your actual content and queries to find what works.
