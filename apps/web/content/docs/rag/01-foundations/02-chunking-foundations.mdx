...
**With Unrag**: Default chunking is configurable via `unrag.config.ts`. See [chunking concepts](/docs/concepts/chunking) for configuration options and custom chunker implementation.
