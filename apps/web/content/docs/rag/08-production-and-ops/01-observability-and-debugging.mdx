...
**With Unrag**: The [debug battery](/docs/debugging) provides real-time observability with a terminal UI that shows traces, timing breakdowns, and chunk details for each ingest and retrieve operation.
