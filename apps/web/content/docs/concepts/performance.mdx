...
Embedding is where the time goes. Each chunk requires an API call to your embedding provider. Unrag embeds chunks concurrently to minimize total latency.
</Callout>
