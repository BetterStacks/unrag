...
<TypeTable
  type={{
    fileCount: {
      description: 'Total number of files that were processed.',
      type: 'number',
    },
    succeeded: {
    ...
    errors: {
      description: 'Array of error details for failed files, each with fileId and error.',
      type: 'Array<{ fileId: string; error: unknown }>',
    },
  }}
/>
...
<TypeTable
  type={{
    ...
    onProgress: {
      description: 'Callback that receives events as each file is processed. Use for logging or progress bars.',
      type: '(event: GoogleDriveSyncProgressEvent) => void',
      default: 'undefined',
    },
    options: {
...
<TypeTable
  type={{
    'file:start': {
      description: 'Emitted when processing begins for a file. Includes fileId and sourceId.',
      type: 'object',
    },
    'file:success': {
      description: 'Emitted when a file is successfully synced. Includes chunkCount for the ingested content.',
      type: 'object',
    },
    'file:skipped': {
      description: 'Emitted when a file is skipped. Includes reason and message explaining why.',
      type: 'object',
    },
    'file:not-found': {
      description: 'Emitted when a file cannot be found or accessed (404/403).',
      type: 'object',
    },
    'file:error': {
      description: 'Emitted when file processing fails with an error.',
      type: 'object',
    },
  }}
/>

The `file:skipped` event's `reason` field can be:
