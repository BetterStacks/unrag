...
See the [Reranker documentation](/docs/batteries/reranker) for installation and configuration details.

## Enhancements to consider

Once your basic search works, you might want to add:

**Reranking**: Improve precision by reordering results with a more expensive relevance model. See the section above and the [Reranker documentation](/docs/batteries/reranker).
...
For deeper coverage of retrieval strategies—including hybrid retrieval, query rewriting, and performance optimization—see [Module 4: Retrieval](/docs/rag/04-retrieval) in the RAG Handbook.
