...
For deeper coverage of content lifecycle management, see [Updates, deletes, and reindexing](/docs/rag/02-data-and-ingestion/05-updates-deletes-and-reindexing) in the RAG Handbook.
