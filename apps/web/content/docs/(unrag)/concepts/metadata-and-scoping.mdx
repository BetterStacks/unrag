...
For deeper coverage of metadata design and access control patterns, see [Metadata, filtering, and permissions](/docs/rag/01-foundations/03-metadata-filtering-and-permissions) in the RAG Handbook.
