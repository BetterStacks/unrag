---
title: ContextEngine
description: The central class that coordinates ingestion, retrieval, deletion, and reranking.
---
...
Reranking is optional and requires installing the reranker battery. It adds latency but significantly improves precision for many use cases. See the [Reranker documentation](/docs/batteries/reranker) for setup and usage details.
...
- [Build a search endpoint](/docs/guides/build-a-search-endpoint) - Complete guide to building production search
- [Reranker battery](/docs/batteries/reranker) - Add two-stage retrieval for improved precision
- [Performance](/docs/concepts/performance) - Understanding and optimizing ingest/retrieve timing
