...
For handling images and PDFs in Notion pages, see [Multimodal content](/docs/concepts/multimodal). For reindexing strategies when your Notion workspace changes, see [Reindexing](/docs/guides/reindexing).
