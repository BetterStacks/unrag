...
For handling documents, PDFs, and images from OneDrive, see [Multimodal content](/docs/concepts/multimodal). For reindexing strategies when your OneDrive content changes, see [Reindexing](/docs/guides/reindexing).
