---
title: CLI Reference
description: Complete reference for the unrag@latest init command and its options.
---
...
```bash
bunx unrag add connector notion
```
...
|------|-------------|--------------|
| `pdf-llm` | Extract text from PDFs using an LLM (Gemini by default) | `ai`, `@ai-sdk/google` |

### Registering extractors

After installing, you need to register the extractor in your `unrag.config.ts`:
