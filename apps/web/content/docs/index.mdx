...
When you run `bunx unrag init`, you get a complete working system:
...
That's the entire API surface. Two methods—`ingest()` and `retrieve()`—plus the configuration to wire them together. Everything else (how you build prompts, how you integrate with chat, how you handle permissions) is up to you.
