...
2. Your app calls UnRAG to retrieve relevant chunks
3. Your app builds a prompt with the chunks as context
4. Your app calls an LLM with the prompt
5. The LLM response is streamed back to the user
