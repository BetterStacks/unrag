...
function TestimonialThreeColumnGrid({
	children,
	...props
...
export function TestimonialsSection() {
	return (
		<TestimonialThreeColumnGrid
			...
			subheadline={
				<p>
					Notes from builders who wanted RAG they could actually own
					and evolve. Ranging from individuals with their passion
					project and teams building at scale.
				</p>
			}
		>
			<Testimonial
				quote={
					<p>
						We needed RAG we could debug and ship. Unrag gave us a
						clean baseline we could read and extend without waiting
						on a vendor.
					</p>
				}
				img={
			...
			<Testimonial
				quote={
					<p>
						The Postgres-first approach fit our stack perfectly. We
						kept our migrations and added vector search without
			...
			<Testimonial
				quote={
					<p>
						The primitives are small enough to audit in one sitting.
						That made compliance reviews fast and painless.
					</p>
				}
				img={
					<img
			...
			<Testimonial
				quote={
					<p>
						We swapped in our own chunker and embedding provider in
						a day. It felt like wiring up utilities, not adopting a
						framework.
					</p>
				}
				img={
			...
			<Testimonial
				quote={
					<p>
						I wanted ownership and clarity. The code lives in my
						repo, and I can change it when my product changes.
					</p>
				}
				img={
					<img
			...
			<Testimonial
				quote={
					<p>
						The install was straightforward, and the engine API is
						refreshingly simple. It feels like part of our code, not
						a dependency we fear.
					</p>
				}
				img={
					<img
