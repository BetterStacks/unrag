...
function NewsletterForm({
	...
	return (
		<form
			className={`flex max-w-sm flex-col gap-2 ${className ?? ''}`}
			{...props}
		>
			<p>{headline}</p>
		...
		<FooterWithNewsletterFormCategoriesAndSocialIcons
			...
			cta={
				<NewsletterForm
					...
					subheadline={
						<p>
							Get release notes, RAG implementation tips, and new
							adapters as they ship.
						</p>
					}
					action="#"
				/>
			...
			links={
				<>
					<FooterCategory title="Product">
						...
						<FooterLink href="/docs/getting-started/quickstart">
							Quickstart
						</FooterLink>
						<FooterLink href="/docs/reference/unrag-config">
							Config reference
						</FooterLink>
					</FooterCategory>
					<FooterCategory title="Company">
						<FooterLink href="https://github.com/BetterStacks/unrag">
							GitHub
						</FooterLink>
						<FooterLink href="/docs/changelog">
							Changelog
						</FooterLink>
						<FooterLink href="/docs/getting-started/introduction">
							About Unrag
						</FooterLink>
					</FooterCategory>
					<FooterCategory title="Resources">
						<FooterLink href="/docs">Documentation</FooterLink>
						<FooterLink href="/docs/concepts/architecture">
							Architecture
						</FooterLink>
						<FooterLink href="/docs/concepts/philosophy">
							Philosophy
						</FooterLink>
						<FooterLink href="/docs/debugging">
							Debugging
						</FooterLink>
					</FooterCategory>
					<FooterCategory title="Legal">
						<FooterLink href="https://github.com/BetterStacks/unrag/blob/main/LICENSE">
							License
						</FooterLink>
					</FooterCategory>
				</>
