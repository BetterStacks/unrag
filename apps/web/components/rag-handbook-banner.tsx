		...
		<div className="mt-16">
			...
			>
				...
				<p className="text-xs leading-relaxed text-slate-600 dark:text-[#d1d5db] opacity-80 my-1">
					Learn RAG from first principles to production operations.
					Tackle decisions, tradeoffs and failure modes in production
					RAG operations
				</p>
				...
				<Button
					size="xs"
					variant="cta"
					className="w-min group-hover:scale-[1.02] group-hover:bg-primary/90 cursor-pointer"
				>
					Take me there
					<ArrowRight
			...
			<span className="sr-only">
				The RAG handbook covers retrieval augmented generation from
				foundational principles through production deployment, including
				quality-latency-cost tradeoffs and operational considerations.
				Click to access the complete handbook.
			</span>
		</div>
	)
}
